...
public class ConfirmOrderServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (orderPhone.isEmpty() == true || orderAddress.isEmpty() == true
				|| orderPhone.compareTo("Enter your phone") == 0) {
			response.setContentType("text/html;charset=UTF-8");
			request.setCharacterEncoding("utf-8");
		...
		final String username = "shopgin094@gmail.com";
		...
		try {
			...
			String emailDefault = request.getParameter("emailOrder").isEmpty() ? "thesoonafu@gmail.com"
					: request.getParameter("emailOrder");
