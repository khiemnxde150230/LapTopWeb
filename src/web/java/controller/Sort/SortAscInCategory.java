...
/**
 * Servlet implementation class SortAscInCategory
 */
@WebServlet("/sortAZcategory")
public class SortAscInCategory extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SortAscInCategory() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("products", new ProductDAO().getSortAZInCategory(request.getParameter("id")));
