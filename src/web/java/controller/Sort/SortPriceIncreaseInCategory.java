...
/**
 * Servlet implementation class SortPriceIncreaseInCategory
 */
@WebServlet("/sortPriceInCategory")
public class SortPriceIncreaseInCategory extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SortPriceIncreaseInCategory() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("products", new ProductDAO().getSortPriceInCategory(request.getParameter("id")));
