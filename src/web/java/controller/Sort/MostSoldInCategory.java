...
/**
 * Servlet implementation class MostSoldInCategory
 */
@WebServlet("/mostsoldcategory")
public class MostSoldInCategory extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MostSoldInCategory() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("products", new ProductDAO().getMostSoldInCategory(request.getParameter("id")));
