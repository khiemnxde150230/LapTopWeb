...
/**
 * Servlet implementation class SortDescInCategory
 */
@WebServlet("/sortZAcategory")
public class SortDescInCategory extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SortDescInCategory() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("products", new ProductDAO().getSortZAInCategory(request.getParameter("id")));
