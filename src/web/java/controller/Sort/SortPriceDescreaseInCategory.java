package web.java.controller.Sort;
...
/**
 * Servlet implementation class SortPriceDescreaseInCategory
 */
@WebServlet("/sortPriceDesCategory")
public class SortPriceDescreaseInCategory extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SortPriceDescreaseInCategory() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("products", new ProductDAO().getSortPriceDesCategory(request.getParameter("id")));
