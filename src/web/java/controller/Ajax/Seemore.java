	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		for (Product product : products) {
			out.print("<div class=\"col-lg-2 mt-5 product_count_start\">\r\n"
					...
					+ "							style=\"padding-top: 4px; height: 220px; display: flex; align-items: center\">\r\n"
					+ "							<img alt=\"\" src=\"" + product.getFirstImage()
					+ "\" style=\"width: 100%\" />\r\n" + "						</div>\r\n"
					+ "						<p class=\"product-sale__item-name\">" + product.getTitle() + "</p>\r\n"
					+ "						<div class=\"product-sale__item-price flex-column align-items-center \">\r\n"
					+ "							<span class=\"product-sale__item-price-curr\">"
					+ product.getFormatPriceStandard() + " ‘</span>\r\n"
					+ "							<span class=\"product-sale__item-price-old\">"
					+ product.getFormatPriceDefault() + " ‘</span>\r\n" + "						</div>\r\n"
					+ "					</a>\r\n" + "				</div>");
		}
	}
