...
/**
 * Servlet implementation class StatisticalMonthly
 */
@WebServlet("/admin/stcalMonthly")
public class StatisticalMonthly extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StatisticalMonthly() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("month6", new Order().getMonthTotal(6));
		request.setAttribute("month7", new Order().getMonthTotal(7));
		request.setAttribute("revenueEachs", new Order().getSingleDayStaticticals());
		request.getRequestDispatcher("../Admin/template/statistical/MonthlyReport.jsp").forward(request, response);
	}
