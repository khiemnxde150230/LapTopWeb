	...
	<div class="home-tab">
		<div
			...
			<ul class="nav nav-tabs" role="tablist">
				...
				<li class="nav-item"><a class="nav-link border-0" id="more-tab"
					data-bs-toggle="tab" href="#more" role="tab" aria-selected="false">More</a></li>
			</ul>
			<div>
				<div class="btn-wrapper">
					<a href="#" class="btn btn-otline-dark align-items-center"><i
						class="icon-share"></i> Share</a> <a href="#"
						class="btn btn-otline-dark"><i class="icon-printer"></i> Print</a>
											...
											<table class="table select-table">
												...
												<tbody>
													<tr>
														...
														<td>
															<div class="d-flex ">
																<img src="../Admin/template/images/faces/face1.jpg"
																	alt="">
																<div>
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																<img src="../Admin/template/images/faces/face2.jpg"
																	alt="">
																<div>
																	<h6>Laura Brooks</h6>
																	<p>Head admin</p>
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																<img src="../Admin/template/images/faces/face3.jpg"
																	alt="">
																<div>
																	<h6>Wayne Murphy</h6>
																	<p>Head admin</p>
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																<img src="../Admin/template/images/faces/face4.jpg"
																	alt="">
																<div>
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																<img src="../Admin/template/images/faces/face5.jpg"
																	alt="">
																<div>
											...
											<div class="wrapper w-100">
												<p class="mb-0">
													<a href="#" class="fw-bold text-primary">Show all <i
														class="mdi mdi-arrow-right ms-2"></i>
													</a>
												</p>
											</div>
										</div>
										...
										<ul class="bullet-line-list">
											<li>
												<div class="d-flex justify-content-between">
													<div>
														<span class="text-light-green">Ben Tossell</span> assign
														you a task
													</div>
													<p>Just now</p>
												</div>
											...
											<li>
												<div class="d-flex justify-content-between">
													<div>
														<span class="text-light-green">Oliver Noah</span> assign
														you a task
													</div>
													<p>1h</p>
												</div>
											...
											<li>
												<div class="d-flex justify-content-between">
													<div>
														<span class="text-light-green">Jack William</span> assign
														you a task
													</div>
													<p>1h</p>
												</div>
											...
											<li>
												<div class="d-flex justify-content-between">
													<div>
														<span class="text-light-green">Leo Lucas</span> assign you
														a task
													</div>
													<p>1h</p>
												</div>
											...
											<li>
												<div class="d-flex justify-content-between">
													<div>
														<span class="text-light-green">Thomas Henry</span> assign
														you a task
													</div>
													<p>1h</p>
												</div>
													...
													<ul class="todo-list todo-list-rounded">
														<li class="d-block">
															<div class="form-check w-100">
																<label class="form-check-label"> <input
																	class="checkbox" type="checkbox"> Lorem Ipsum
											...
											<div class="col-lg-12">
												...
												<div class="mt-3">
													<div
														...
														<div class="d-flex">
															<img class="img-sm rounded-10"
																src="../Admin/template/images/faces/face1.jpg"
																alt="profile">
													...
													<div
														...
														<div class="d-flex">
															<img class="img-sm rounded-10"
																src="../Admin/template/images/faces/face2.jpg"
																alt="profile">
															<div class="wrapper ms-3">
													...
													<div
														...
														<div class="d-flex">
															<img class="img-sm rounded-10"
																src="../Admin/template/images/faces/face3.jpg"
																alt="profile">
															<div class="wrapper ms-3">
													...
													<div
														...
														<div class="d-flex">
															<img class="img-sm rounded-10"
																src="../Admin/template/images/faces/face4.jpg"
																alt="profile">
															<div class="wrapper ms-3">
													...
													<div
														...
														<div class="d-flex">
															<img class="img-sm rounded-10"
																src="../Admin/template/images/faces/face5.jpg"
																alt="profile">
															<div class="wrapper ms-3">
