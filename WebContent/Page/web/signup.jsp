		...
		<div class="container">
			<div class="main">
				<form action="signup" method="post" class="form" id="form-signup">
					<h3 class="login-title">Đăng Kí Thành Viên</h3>
					<div class="form-group">
						<input type="text" id="name" name="fullname"
							placeholder="Tên đầy đủ"> <span class="form-message"></span>
					</div>
					<div class="form-group">
						<input type="text" id="surname" name="username"
							placeholder="Username"> <span class="form-message"></span>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<input type="password" id="password" name="password"
							placeholder="Mât khẩu"> <span class="form-message"></span>
					</div>
					<div class="form-group">
					...
					<input type="submit" class="btn btn-success" value="Đăng kí" /> <a
						href="home" class="login-not btn ">Quay Về</a>
				</form>
			</div>
		</div>
	</div>
